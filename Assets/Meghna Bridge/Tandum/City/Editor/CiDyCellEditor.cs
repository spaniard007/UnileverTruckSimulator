...
namespace CiDy
{
    ...
    public class CiDyCellEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.Space();
            GUILayout.Label("Sidewalk Path Light Parameters:", EditorStyles.boldLabel);
            ...
            //Turn Off Clutter
            cell.enableClutter = EditorGUILayout.Toggle("Enable Clutter", cell.enableClutter);
            //Show Disable Clutter Toggle
            if (cell.enableClutter)
            {
                //Show All Clutter and there Options
