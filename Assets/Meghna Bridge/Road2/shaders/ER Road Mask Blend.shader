	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord32 = input.ase_texcoord9.zw * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord40 = input.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float2 texCoord32 = input.ase_texcoord4.zw * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode30 = tex2D( _Mask, texCoord32 );
				float4 lerpResult16 = lerp( ( tex2DNode1 * _Color ) , ( tex2D( _Albedo, uv_Albedo ) * _Color0 ) , tex2DNode30.g);
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float2 texCoord32 = input.ase_texcoord2.zw * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode30 = tex2D( _Mask, texCoord32 );
				float4 lerpResult16 = lerp( ( tex2DNode1 * _Color ) , ( tex2D( _Albedo, uv_Albedo ) * _Color0 ) , tex2DNode30.g);
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 texCoord40 = input.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float3 unpack5 = UnpackNormalScale( tex2D( _BumpMap, texCoord40 ), _BumpScale );
				unpack5.z = lerp( 1, unpack5.z, saturate(_BumpScale) );
