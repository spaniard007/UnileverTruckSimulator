	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv4_DetailAlbedoMap = input.ase_texcoord9.zw * _DetailAlbedoMap_ST.xy + _DetailAlbedoMap_ST.zw;
				float4 lerpResult41 = lerp( ( tex2D( _MainTex, uv_MainTex ) * _Color ) , ( tex2D( _DetailAlbedoMap, uv4_DetailAlbedoMap ) * _Color ) , input.ase_color.r);
				...
				float3 lerpResult42 = lerp( unpack5 , tex2DNode36 , input.ase_color.r);
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float2 uv4_DetailAlbedoMap = input.ase_texcoord4.zw * _DetailAlbedoMap_ST.xy + _DetailAlbedoMap_ST.zw;
				float4 lerpResult41 = lerp( ( tex2D( _MainTex, uv_MainTex ) * _Color ) , ( tex2D( _DetailAlbedoMap, uv4_DetailAlbedoMap ) * _Color ) , input.ase_color.r);
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float2 uv4_DetailAlbedoMap = input.ase_texcoord2.zw * _DetailAlbedoMap_ST.xy + _DetailAlbedoMap_ST.zw;
				float4 lerpResult41 = lerp( ( tex2D( _MainTex, uv_MainTex ) * _Color ) , ( tex2D( _DetailAlbedoMap, uv4_DetailAlbedoMap ) * _Color ) , input.ase_color.r);
		...
		Pass
		{
						 ...
						 )
			{
				...
				float3 unpack5 = UnpackNormalScale( tex2D( _BumpMap, texCoord26 ), _BumpScale );
				unpack5.z = lerp( 1, unpack5.z, saturate(_BumpScale) );
				float2 uv4_DetailAlbedoMap = input.ase_texcoord5.zw * _DetailAlbedoMap_ST.xy + _DetailAlbedoMap_ST.zw;
				float3 unpack36 = UnpackNormalScale( tex2D( _BumpMap, uv4_DetailAlbedoMap ), _BumpScale );
				unpack36.z = lerp( 1, unpack36.z, saturate(_BumpScale) );
				float3 tex2DNode36 = unpack36;
				float3 lerpResult42 = lerp( unpack5 , tex2DNode36 , input.ase_color.r);
